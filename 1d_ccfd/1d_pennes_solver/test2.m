...
sense = SenseFunction(dom,U(:,1));
blood = ColumnVector(dx,pennes.cellCenters);
stiff_coupled = StiffnessMatrixCoupled(stiff,sense,blood,alpha);
S_bar = stiff_coupled.matrix;
