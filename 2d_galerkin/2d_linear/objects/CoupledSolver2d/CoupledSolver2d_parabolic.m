classdef CoupledSolver2d_parabolic < NewtonGalerkinSolver2d_parabolic
	...
	methods
		function self = CoupledSolver2d_parabolic(PDE,ODE,auxfun)
			
			% call superclass constructor
			self@NewtonGalerkinSolver2d_parabolic(PDE.domain,auxfun);
        ...
        function self = solveTimestep(self,S,b,FreeNodes)
            ...
            for iter = 1:100
				...
				% solve PDE iteration
                [self, U_tilde, W] = self.PDE.solveIteration(U_tilde);
