classdef NewtonGalerkinMMS2d_heat < NewtonGalerkinMMS2d_parabolic
...
%-----------------------------------------------------------------------------%
	...
	methods
		function self = NewtonGalerkinMMS2d_heat(dom,auxfun,mmsparams,NameValueArgs)
		...
		function prob = solve(self,dom,cofs)
			...
			prob = NewtonGalerkinSolver2d_heat(dom,cofs);
