classdef ManufacturedFunctions2d_frostbite < ManufacturedFunctions2d_rxndiff
...
%-----------------------------------------------------------------------------%
	...
	properties
		c		% ODE heat capacity
		s		% ODE coupling term
		vTrue	% desired ODE solution
	end

	methods
		function self = ManufacturedFunctions2d_frostbite(p,k,r,uTrue,c,s,vTrue,NameValueArgs)
