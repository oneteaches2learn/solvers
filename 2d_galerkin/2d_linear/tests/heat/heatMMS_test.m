function [pass,mms] = heatMMS_test(dom,params,options)

	% MMS TEST %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	fprintf('MMS Test Begun\n')

	% assemble inputs
	auxfun    = ManufacturedFunctions2d_heat(params.c,params.k,params.uTrue);
	...
	% run mms test
	mms = GalerkinMMS2d_heat(dom,auxfun,mmsparams,errType="L2");
