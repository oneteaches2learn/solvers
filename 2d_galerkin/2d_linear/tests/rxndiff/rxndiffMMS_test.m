function [pass,mms] = rxndiffMMS_test(dom,params,options)

	% MMS TEST %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	fprintf('MMS Test Begun\n')

	% assemble inputs
	auxfun    = ManufacturedFunctions2d_rxndiff(params.c,params.k,params.r,params.uTrue);
	...
	% run mms test
	mms = GalerkinMMS2d_rxndiff(dom,auxfun,mmsparams,errType="L2");
