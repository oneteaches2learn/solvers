classdef GalerkinMMS2d_pennes < GalerkinMMS2d_parabolic
...
%-----------------------------------------------------------------------------%
	...
	methods
		function self = GalerkinMMS2d_pennes(dom,auxfun,mmsparams,NameValueArgs)

			arguments
				dom 		Domain2d
				auxfun  	ManufacturedFunctions2d_pennes
				mmsparams 	MMSParams
		...
		function prob = solve(self,dom,cofs)
			...
			prob = GalerkinSolver2d_pennes(dom,cofs);
